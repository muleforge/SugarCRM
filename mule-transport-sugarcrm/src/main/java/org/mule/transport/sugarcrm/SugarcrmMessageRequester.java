/*
 * $Id: SugarcrmMessageRequester.java 1009 2010-09-22 15:55:54Z gdimech $
 * --------------------------------------------------------------------------------------
 ...
 */
public class SugarcrmMessageRequester extends AbstractMessageRequester
{
    ...
    public SugarcrmMessageRequester(InboundEndpoint endpoint)
    {
        super(endpoint);
    }
