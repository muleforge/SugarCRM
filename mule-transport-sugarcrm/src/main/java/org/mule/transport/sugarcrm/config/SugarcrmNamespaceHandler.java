/*
 * $Id: SugarcrmNamespaceHandler.java 1009 2010-09-22 15:55:54Z gdimech $
 * --------------------------------------------------------------------------------------
 ...
 * LICENSE.txt file.
 */
package org.mule.transport.sugarcrm.config;

import org.mule.config.spring.handlers.AbstractMuleNamespaceHandler;
import org.mule.transport.sugarcrm.SugarcrmConnector;
import org.mule.endpoint.URIBuilder;

import org.springframework.beans.factory.xml.NamespaceHandlerSupport;

/**
 * Registers a Bean Definition Parser for handling <code><sugarcrm:connector></code> elements
 * and supporting endpoint elements.
 */
public class SugarcrmNamespaceHandler extends AbstractMuleNamespaceHandler
{
    public void init()
    {
         ...
         */
        registerStandardTransportEndpoints(SugarcrmConnector.SUGARCRM, URIBuilder.PATH_ATTRIBUTES);
        ...
        */
        registerConnectorDefinitionParser(SugarcrmConnector.class);
    }
}
