...
/**
 * <code>SugarMessageDispatcher</code> TODO document
 */
public class SugarMessageDispatcher extends AbstractMessageDispatcher
{

    /* For general guidelines on writing transports see
       http://mule.mulesource.org/display/MULE/Writing+Transports */

    public SugarMessageDispatcher(UMOImmutableEndpoint endpoint)
    {
        super(endpoint);
        ...
        /* IMPLEMENTATION NOTE: If you need a reference to the specific
           ...
           SugarConnector cnn = (SugarConnector)endpoint.getConnector(); */
    }
